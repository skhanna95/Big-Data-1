...
total_iterations_input = float(sys.argv[1])
...
def main():
    partition_slices = 100
    iteration_count = total_iterations_input/partition_slices
    ...
    result = float(claculate)/total_iterations_input
    print("\n\n\n")
    print (result)
